...
echo "Subject: [Centipede]:"$MP" deconnectee depuis $MIN minutes" > $MAILFILE 
...
echo "Votre Base RTK $MP ou votre reseau internet est eteint ou defaillant car aucune donnee n'a ete renvoyee au caster.centipede.fr:2101 dans les dernieres $MIN minutes" >> $MAILFILE
